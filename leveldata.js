...
let LEVELS = [
    ...
    {id: 5, name: "level 5",
        ...
        conveyorBelt: {
            items: [MILK, BLANK, COFFE, FLOUR, BLANK, MILK, COFFE, BLANK, FLOUR, MILK, MILK],
            speed: 1.5
        },
    ...
    {id: 12, name: "stage 12",
        ...
        conveyorBelt: {
            items: [RICE, BLANK, NORI, NORI, BLANK, RICE, SOUP, ORANGE, BLANK, BLANK, KIWI, SOUP, BLANK, SOUP],
            speed: 1.5
        },
